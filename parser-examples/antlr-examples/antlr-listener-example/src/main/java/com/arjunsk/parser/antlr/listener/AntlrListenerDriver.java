...
import com.arjunsk.parser.antlr.listener.support.SimplerLangListenerImpl;
import org.antlr.v4.runtime.CharStreams;
import org.antlr.v4.runtime.CommonTokenStream;

public class AntlrListenerDriver {
  ...
  private static void compile(String source) {
    ...
    parser.addParseListener(new SimplerLangListenerImpl());
    parser.program();
  }
}
